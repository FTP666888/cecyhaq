...
<body class="adminbody">
    ...
    <div class="container">
        ...
        <div class="contenido">
            <h1>Control de Enchufes</h1>
            <div class="row">
                <div class="column">
                    <div class="enchufe">
                        <h2>Enchufe 1</h2>
                        <p>Estado: <span id="estado1">Apagado</span></p>
                        <button onclick="cambiarEstado('estado1')">Cambiar Estado</button>
                    </div>
                    <div class="enchufe">
                        <h2>Enchufe 2</h2>
                        <p>Estado: <span id="estado2">Apagado</span></p>
                        <button onclick="cambiarEstado('estado2')">Cambiar Estado</button>
                    </div>
                </div>
                <div class="column">
                    <div class="panel">
                        <h2>Panel de Inteligencia Artificial</h2>
                        <div id="barra" style="width: 0%; background-color: #4caf50; height: 20px;"></div>
                    </div>
                </div>
            </div>
            <script>
                function cambiarEstado(id) {
                    ...
                    if (estado.innerText === 'Apagado') {
                        estado.innerText = 'Encendido';
                    } else {
                ...
                function actualizarBarra() {
                    ...
                    barra.style.width = Math.floor(Math.random() * 100) + '%';
                }
            </script>
        </div>
